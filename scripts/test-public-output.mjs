...
for (const relativePath of ["index.html", "kernel-status.js", "llms.txt", "mobile-chain-status.js", "status-monitor.js", "styles.css", "technical-data.js", ".well-known/security.txt", ".well-known/fenrua-release.json"]) {
  assert.deepEqual(
